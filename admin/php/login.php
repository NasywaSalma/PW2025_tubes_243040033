    ...
    <div class="container mt-4 mb-5">
        <div class="card shadow-lg">
            <div class="header text-white d-flex justify-content-between align-items-center bg-primary p-3 rounded-top">
                <h4 class="mb-0"><i class="bi bi-table me-2"></i>User</h4>
                <a href="tambah/subscribe.php" class="btn btn-light btn-custom shadow-sm"><i class="bi bi-plus-circle me-1"></i>add data</a>
            </div>
            <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="aksi-btns">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <a href="hapus/hapuslogin.php?id=<?= $akun['id']; ?>" class="btn btn-danger btn-sm btn-custom" onclick="return confirm('Delete this contact?');" title="Hapus Data">
